        ...
        tr += `
         <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo" data-edit-id="${item.id}">Open modal for @mdo</button>
                </td>
            </tr>`
    })
